...
const statusColorMap = {
  ...
  completed: "bg-yellow-500/20 text-yellow-800 border-yellow-800/5",
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Badge variant="outline" className="capitalize [&>svg]:size-4 flex items-center gap-x-2">
        ...
        {row.original.duration ? formatDuration(row.original.duration) : "Sem duração"}
      </Badge>
    ),
  },
];
